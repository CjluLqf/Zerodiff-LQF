...
--netR_model_path ./out/CUB/zerodiff_DRG_100percent_att:att_b:64_lr:0.0001_n_T:4_betas:0.1,20_gamma:ADV:10.0_VAE:1.0_x0:1.0_xt:1.0_dist:0.0_num:300_gzsl.tar \
''')
...
# --netR_model_path ./out/CUB/zerodiff_DRG_30percent_att:att_b:64_lr:0.0001_n_T:4_betas:0.1,20_gamma:ADV:10.0_VAE:1.0_x0:1.0_xt:1.0_dist:0.0_num:100_gzsl.tar \

# split_percent 10:
# --split_percent 10 --syn_num 140
# --netR_model_path ./out/CUB/zerodiff_DRG_10percent_att:att_b:64_lr:0.0001_n_T:4_betas:0.1,20_gamma:ADV:10.0_VAE:1.0_x0:1.0_xt:1.0_dist:0.0_num:40_gzsl.tar \